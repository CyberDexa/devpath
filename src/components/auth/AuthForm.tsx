    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="flex flex-col gap-3 mb-6">
        <button
          ...
          className="flex items-center justify-center gap-2 w-full rounded-lg border border-[var(--color-charcoal)] bg-[var(--color-abyss)] px-4 py-2.5 text-sm font-medium text-white hover:bg-white/[0.04] transition-colors"
        >
          <Github size={18} />
