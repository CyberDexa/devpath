...
INSERT INTO job_listings (title, company, location, remote_type, salary_min, salary_max, description, required_skills, experience_level, job_type, apply_url, posted_at)
VALUES
  ('Frontend Engineer', 'TechCorp', 'San Francisco, CA', 'hybrid', 120000, 180000, 'Build beautiful, performant web applications using React and TypeScript. Work with a world-class design team to deliver pixel-perfect UIs.', ARRAY['react', 'typescript', 'css', 'html', 'javascript'], 'mid', 'full-time', 'https://example.com/apply/frontend', NOW()),
  ('Senior Backend Developer', 'DataFlow Inc', 'New York, NY', 'remote', 150000, 220000, 'Design and implement scalable APIs and microservices. Experience with Node.js, PostgreSQL, and distributed systems required.', ARRAY['nodejs', 'postgresql', 'docker', 'typescript', 'api-design'], 'senior', 'full-time', 'https://example.com/apply/backend', NOW()),
  ('Full Stack Engineer', 'StartupXYZ', 'Austin, TX', 'remote', 100000, 160000, 'Join our small team building the future of developer tools. Must be comfortable across the stack from React to PostgreSQL.', ARRAY['react', 'nodejs', 'postgresql', 'typescript', 'git'], 'mid', 'full-time', 'https://example.com/apply/fullstack', NOW()),
  ('DevOps Engineer', 'CloudScale', 'Seattle, WA', 'hybrid', 140000, 200000, 'Manage CI/CD pipelines, Kubernetes clusters, and cloud infrastructure. Help us ship faster and more reliably.', ARRAY['kubernetes', 'docker', 'aws', 'terraform', 'ci-cd'], 'mid', 'full-time', 'https://example.com/apply/devops', NOW()),
  ('Junior Developer', 'LearnTech', 'Remote', 'remote', 70000, 95000, 'Great opportunity for developers starting their career. Mentorship included. Work on React frontends and Python backends.', ARRAY['javascript', 'react', 'python', 'git'], 'entry', 'full-time', 'https://example.com/apply/junior', NOW()),
  ('AI/ML Engineer', 'NeuralWorks', 'Boston, MA', 'hybrid', 160000, 240000, 'Build production ML pipelines and integrate LLMs into our product. Experience with PyTorch and cloud ML services required.', ARRAY['python', 'pytorch', 'tensorflow', 'docker', 'aws'], 'senior', 'full-time', 'https://example.com/apply/ml', NOW()),
  ('React Native Developer', 'MobileFirst', 'Los Angeles, CA', 'remote', 110000, 170000, 'Build cross-platform mobile applications. Strong React Native experience and understanding of native iOS/Android required.', ARRAY['react-native', 'typescript', 'javascript', 'ios', 'android'], 'mid', 'full-time', 'https://example.com/apply/mobile', NOW()),
  ('Platform Engineer', 'InfraTeam', 'Chicago, IL', 'onsite', 130000, 190000, 'Design and build internal developer platforms. Make other engineers more productive with great tooling.', ARRAY['golang', 'kubernetes', 'terraform', 'docker', 'linux'], 'senior', 'full-time', 'https://example.com/apply/platform', NOW());
